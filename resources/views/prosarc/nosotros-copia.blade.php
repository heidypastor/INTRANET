					...
					<ul>
						<li>
							...
							<div class="col-md-12 row">
								<div class="col-md-5 mx-auto text-center actividades">
								<br><strong>ACTIVIDADES</strong>
								</div>
								<div class="col-md-5 mx-auto text-center procesos">
						...
						<br>
						<li>
							Garantizar que los servicios de recolección, transporte, manejo, tratamiento, incineración y destrucción de toda clase de desechos y residuos sean oportunos, adecuados y seguros, previniendo la contaminación y la disminuyendo los impactos que se puedan generar a los recursos naturales.
							<div class="col-md-12 row">
								<div class="col-md-5 mx-auto text-center actividades">
								<br><strong>ACTIVIDADES</strong>
								</div>
							...
							<div class="col-md-12 row">
								...
								<div class="col-md-5 mx-auto text-center procesos">
								<br><p>TRATAMIENTO TERMICO/GETIÓN AMBIENTAL</p>
								</div>
							</div>
							<div class="col-md-12 row">
								<div class="col-md-5 mx-auto text-center actividades">
						...
						<li>
							...
							<div class="col-md-12 row">
								<div class="col-md-5 mx-auto text-center actividades">
								<br><p>Garantizar acciones de seguimiento y verificación de nuestros los requisitos legales.</p>
								</div>
								<div class="col-md-5 mx-auto text-center procesos">
								<br><p>TODOS LOS PROCESOS</p>
								</div>
